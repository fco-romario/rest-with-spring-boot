...
import br.com.romario.api_gateway.serialization.converter.YamlJackson2HttpMesageConverter;
...
public class WebConfig implements WebMvcConfigurer {
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		// header : Key= Accept e value = application/xml | Key= Content-Type e value = application/xml
